...
//           <button className="btn btn-outline btn-dark me-2" onClick={()=>setFilter(data)}>all</button>
//           <button className="btn btn-outline btn-dark me-2" onClick={()=>filterProduct("men's clothing")}>men's clothing</button>
//           <button className="btn btn-outline btn-dark me-2"onClick={()=>filterProduct("women's clothing")}>women's clothing</button>
//           <button className="btn btn-outline btn-dark me-2"onClick={()=>filterProduct("jewelery")}>jewelry</button>
//           <button className="btn btn-outline btn-dark me-2"onClick={()=>filterProduct("Electronics")}>Electronics</button>
//         </div>
            ...
            <div key={product.id} className="col-md-3">
              <div className="card h-100 text-center p-4">
                ...
                <div className="card-body">
                  <h5 className="card-title">{product.title.substring(0, 12)}</h5>
                  <p className="card-text">${product.price}</p>
                  <NavLink to={`/productpage/${product.id}`} className="btn btn-outline-dark">buy now</NavLink>
                </div>
              </div>
            </div>
          );
